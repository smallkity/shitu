...
const photos = ["one.jpg", "two.jpg", "three.jpg"].map(
  (fileName, index): PhotoRecord => ({
    id: `photo-${index + 1}`,
    fileName,
    mimeType: "image/jpeg",
    size: 10,
